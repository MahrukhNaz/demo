...
class headInjuries extends StatefulWidget {
  const headInjuries({Key? key}) : super(key: key);

  @override
  State<headInjuries> createState() => _headInjuries();
}

class _headInjuries extends State<headInjuries>{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.red.shade600, // Set the app bar background color to red.shade600
        title: const Text("Head Injuries"), // Set the app bar title
      ),
      body: Column(
        children: <Widget>[
          Expanded(
            child: Center(
              child: Lottie.asset(
                'Assets/Animation/9.json', // Replace with the actual path to your Lottie animation file
