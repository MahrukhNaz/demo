...
class heartAttack extends StatefulWidget {
  ...
  @override
  State<heartAttack> createState() => _heartAttack();
}

class _heartAttack extends State<heartAttack>{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.red.shade600, // Set the app bar background color to red.shade600
        title: const Text("Head Attack"), // Set the app bar title
      ),
      body: Column(
        children: <Widget>[
          Expanded(
            child: Center(
              child: Lottie.asset(
                'Assets/Animation/26.json', // Replace with the actual path to your Lottie animation file
