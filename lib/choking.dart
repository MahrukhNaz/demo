...
class choking extends StatefulWidget {
  ...
  @override
  State<choking> createState() => _choking();
}

class _choking extends State<choking>{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.red.shade600, // Set the app bar background color to red.shade600
        title: const Text("Choking"), // Set the app bar title
      ),
      body: Column(
        children: <Widget>[
          Expanded(
            child: Center(
              child: Lottie.asset(
                'Assets/Animation/11.json', // Replace with the actual path to your Lottie animation file
