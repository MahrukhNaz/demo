...
class seizure extends StatefulWidget {
  const seizure({Key? key}) : super(key: key);

  @override
  State<seizure> createState() => _seizure();
}

class _seizure extends State<seizure>{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.red.shade600, // Set the app bar background color to red.shade600
        title: const Text("Seizure"), // Set the app bar title
      ),
      body: Column(
        children: <Widget>[
          Expanded(
            child: Center(
              child: Lottie.asset(
                'Assets/Animation/25.json', // Replace with the actual path to your Lottie animation file
