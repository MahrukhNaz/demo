...
class burns extends StatefulWidget {
  ...
  @override
  State<burns> createState() => _burns();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Burns"), // Set the app bar title
      ),
      body: Column(
        children: <Widget>[
          Expanded(
            child: Center(
              child: Lottie.asset(
                'Assets/Animation/27.json', // Replace with the actual path to your Lottie animation file
